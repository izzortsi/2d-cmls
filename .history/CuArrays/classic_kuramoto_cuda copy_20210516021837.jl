...
kura_gpu!(θ, ω, dθ) = @cuda blocks = (nblocks, nblocks) threads = (nthreads, nthreads) kernel(θ, ω, dθ)
# %%
@cuda blocks = (nblocks, nblocks) threads = (nthreads, nthreads) kernel(θ, ω, dθ)
# %%
