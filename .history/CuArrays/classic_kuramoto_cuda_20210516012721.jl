...
function setup_call(n::Int64)
    ...
    gpu_sin(dθ, out) = @cuda blocks = (numblocks, numblocks) threads = (threads, threads) dynamic=true sin_gpu(dθ, out)
    return conv, gpu_sin
end
# %%
# %%
